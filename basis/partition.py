"""
Integer partitions with a per-component lower bound.

Used by ``SmolyakIndexing`` to enumerate all multi-indices (i_1, …, i_d)
with i_j ≥ limit and Σ i_j = exact_sum.
"""


class Partition:
    """Lazy generator of compositions of *exact_sum* into *dim* parts ≥ *limit*."""
    ...
    def __init__(self, dim, exact_sum, limit=1):
        ...
        # Work in the "reduced" space where each part starts at 0
    ...
    def get(self):
        """Return the next composition, or the last one again if exhausted."""
