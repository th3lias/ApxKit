...
\] % TODO: Where was this found -> cite
...
normed space \(X\), % TODO: Do we really need to explain what B(X) is in the 
% TODO: following
...
% TODO: Or just: With X^\star we denote the dual space
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
