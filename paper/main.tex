...
\begin{equation}\label{eq:barycentricLagrange} % TODO: Woher???
...
for the recomputation of said weights. The general identity % TODO: Woher?
 \[
    w_n = \frac{1}{\prod_{\substack{j=0\\j \neq n}}^N x_n - x_j} = \frac{1}{\ell'(x_n)}
\]
always holds. To specify the above, consider the set of \emph{equidistant} 
...
\propto 1/\sqrt{1-x^2}\).\newline 
% TODO: Call this Chebyshev Density?
...
\[
    ...
    \end{cases}
\]
% TODO: Is the following citation correct?
