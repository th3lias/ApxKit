...
class GenzFunctionTests(unittest.TestCase):
    ...
    def test_osciallatory_2d(self):
        ...
        data = self.get_2d_testpoints()
        y_hat = f_hat(data)
        y = f(data)

        self.assertTrue(np.isclose(y_hat, y).all())

    def test_osciallatory_4d(self):
        d = 4
