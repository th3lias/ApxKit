...
class FunctionTests(unittest.TestCase):
    ...
    def test_oscillatory_1d_1(self):
        ...
        f_hat = get_test_function(FunctionType.OSCILLATORY, d, np.array([1]), np.array([0]))
    ...
    def test_oscillatory_1d_2(self):
        ...
        f_hat = get_test_function(FunctionType.OSCILLATORY, d, np.array([0.5]), np.array([-0.25]))
    ...
    def test_oscillatory_2d(self):
        ...
        f_hat = get_test_function(FunctionType.OSCILLATORY, d, np.array([-1, 2]), np.array([-2.1, 0]))
    ...
    def test_oscillatory_4d(self):
        ...
        f_hat = get_test_function(FunctionType.OSCILLATORY, d, np.array([-12, -12, 1, 2.3]), np.array([1.2, 0, 1, 4]))
    ...
    def test_product_peak_1d_1(self):
        ...
        f_hat = get_test_function(FunctionType.PRODUCT_PEAK, c=np.array([np.sqrt(2)]), w=np.array([3 / 8]), d=d)
    ...
    def test_product_peak_1d_2(self):
        ...
        f_hat = get_test_function(FunctionType.PRODUCT_PEAK, c=np.array([3]), w=np.array([1]), d=d)
    ...
    def test_product_peak_2d(self):
        ...
        f_hat = get_test_function(FunctionType.PRODUCT_PEAK, c=np.array([0.2, 1.5]), w=np.array([0.5, 0.25]), d=d)
        f = lambda t: 1 / (
    ...
    def test_product_peak_4d(self):
        ...
        f_hat = get_test_function(FunctionType.PRODUCT_PEAK, c=np.array([-0.7, 0.2, 0.1, 1 / 3]),
    ...
    def test_corner_peak_1d_1(self):
        ...
        f_hat = get_test_function(FunctionType.CORNER_PEAK, c=np.array([np.exp(1)]), w=None, d=d)
    ...
    def test_corner_peak_1d_2(self):
        ...
        f_hat = get_test_function(FunctionType.CORNER_PEAK, c=np.array([1]), w=None, d=d)
    ...
    def test_corner_peak_2d(self):
        ...
        f_hat = get_test_function(FunctionType.CORNER_PEAK, c=np.array([0.2, 1.5]), w=None, d=d)
    ...
    def test_corner_peak_4d(self):
        ...
        f_hat = get_test_function(FunctionType.CORNER_PEAK, c=np.array([-0.7, 0.2, 0.1, 1.2]), w=None, d=d)
    ...
    def test_gaussian_1d_1(self):
        ...
        f_hat = get_test_function(FunctionType.GAUSSIAN, c=np.array([0.6]), w=np.array([0.35]), d=d)
    ...
    def test_gaussian_1d_2(self):
        ...
        f_hat = get_test_function(FunctionType.GAUSSIAN, c=np.array([-0.1]), w=np.array([-0.1]), d=d)
    ...
    def test_gaussian_2d(self):
        ...
        f_hat = get_test_function(FunctionType.GAUSSIAN, c=np.array([0.2, 1.5]), w=np.array([1, 2]), d=d)
    ...
    def test_gaussian_4d(self):
        ...
        f_hat = get_test_function(FunctionType.GAUSSIAN, c=np.array([np.sqrt(2), 1 / 6, 0, 1]),
    ...
    def test_continuous_1d_1(self):
        ...
        f_hat = get_test_function(FunctionType.CONTINUOUS, c=np.array([0.6]), w=np.array([0.35]), d=d)
    ...
    def test_continuous_1d_2(self):
        ...
        f_hat = get_test_function(FunctionType.CONTINUOUS, c=np.array([-0.1]), w=np.array([-0.1]), d=d)
    ...
    def test_continuous_2d(self):
        ...
        f_hat = get_test_function(FunctionType.CONTINUOUS, c=np.array([0.2, 1.5]), w=np.array([1, 2]), d=d)
    ...
    def test_continuous_4d(self):
        ...
        f_hat = get_test_function(FunctionType.CONTINUOUS, c=np.array([np.sqrt(2), 1 / 6, 0.237, -3]),
    ...
    def test_discontinuous_1d_1(self):
        ...
        f_hat = get_test_function(FunctionType.DISCONTINUOUS, c=np.array([0.6]), w=np.array([0.35]), d=d)
    ...
    def test_discontinuous_1d_2(self):
        ...
        f_hat = get_test_function(FunctionType.DISCONTINUOUS, c=np.array([-0.1]), w=np.array([-0.1]), d=d)
    ...
    def test_discontinuous_2d(self):
        ...
        f_hat = get_test_function(FunctionType.DISCONTINUOUS, c=np.array([0.2, 1.5]), w=np.array([1, 2]), d=d)
    ...
    def test_discontinuous_4d(self):
        ...
        f_hat = get_test_function(FunctionType.DISCONTINUOUS, c=np.array([np.sqrt(2), 1 / 6, 1.1, -0.7]),
