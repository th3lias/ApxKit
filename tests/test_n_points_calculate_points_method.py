...
class TestNumberChebyshevPoints(unittest.TestCase):
    ...
    def test_dim1(self):
        ...
        for scale in range(1, 11):
            points = calculate_num_points(dim=1, scale=scale)
    ...
    def test_dim2(self):
        ...
        for scale in range(1, 11):
            points = calculate_num_points(dim=2, scale=scale)
            results.append(points)
    ...
    def test_dim5(self):
        ...
        for scale in range(1, 11):
            points = calculate_num_points(dim=5, scale=scale)
            results.append(points)
    ...
    def test_dim10(self):
        ...
        for scale in range(1, 11):
            points = calculate_num_points(dim=10, scale=scale)
            results.append(points)
