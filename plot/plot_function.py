...
def plot_errors(dimension, seed: int, function_type: FunctionType, scales: list[int], multiplier_fun: Callable,
                folder_name: str, path: str = None, save: bool = False, save_path: str = None,
                same_axis_both_plots: bool = True, latex: bool = False):
    """
    ...
    if not smolyak_data.empty:
        ...
        print("Warning: Smolyak data is empty, skipping plot.")
